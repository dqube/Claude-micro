...
public interface IMessagePublisher
{
    ...
    Task PublishAsync<TMessage>(TMessage message, MessageEnvelop metadata, CancellationToken cancellationToken = default)
        where TMessage : class;

    Task PublishAsync<TMessage>(TMessage message, string destination, MessageEnvelop metadata, CancellationToken cancellationToken = default)
        where TMessage : class;
