...
public class SalesByStoreSpecification : Specification<Sale>
{
    private readonly int _storeId;
    private readonly DateTime? _fromDate;
    private readonly DateTime? _toDate;

    public SalesByStoreSpecification(int storeId, DateTime? fromDate = null, DateTime? toDate = null)
    {
        _storeId = storeId;
        _fromDate = fromDate;
        _toDate = toDate;
    ...
    public override Expression<Func<Sale, bool>> Criteria
    {
        get
        {
            Expression<Func<Sale, bool>> criteria = s => s.StoreId == _storeId && !s.IsDeleted;
