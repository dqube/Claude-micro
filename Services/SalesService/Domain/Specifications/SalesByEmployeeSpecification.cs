...
public class SalesByEmployeeSpecification : Specification<Sale>
{
    private readonly Guid _employeeId;
    private readonly DateTime? _fromDate;
    private readonly DateTime? _toDate;

    public SalesByEmployeeSpecification(Guid employeeId, DateTime? fromDate = null, DateTime? toDate = null)
    {
    ...
    public override Expression<Func<Sale, bool>> Criteria
    {
        get
        {
            Expression<Func<Sale, bool>> criteria = s => s.EmployeeId == _employeeId && !s.IsDeleted;
