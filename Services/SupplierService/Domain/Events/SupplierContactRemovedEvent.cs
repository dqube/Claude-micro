...
public class SupplierContactRemovedEvent : DomainEventBase
{
    ...
    public SupplierContactRemovedEvent(SupplierId supplierId, ContactId contactId, string firstName, string lastName)
    {
