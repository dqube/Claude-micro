...
public class PurchaseOrderDetailAddedEvent : DomainEventBase
{
    ...
    public PurchaseOrderDetailAddedEvent(OrderId orderId, OrderDetailId orderDetailId, Guid productId, int quantity, decimal unitCost)
    {
