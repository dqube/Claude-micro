...
public class SupplierAddressAddedEvent : DomainEventBase
{
    ...
    public SupplierAddressAddedEvent(SupplierId supplierId, AddressId addressId, string line1, string city)
    {
