...
public class RemoveCashCommandHandler : ICommandHandler<RemoveCashCommand>
{
    private readonly IRepository<Register, RegisterId> _registerRepository;
    private readonly IUnitOfWork _unitOfWork;

    public RemoveCashCommandHandler(
    ...
    public async Task HandleAsync(RemoveCashCommand request, CancellationToken cancellationToken)
    {
        ...
        register.RemoveCash(request.Amount, request.Note);
