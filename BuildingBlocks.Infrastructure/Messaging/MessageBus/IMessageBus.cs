...
public interface IMessageBus
{
    ...
    Task PublishAsync<T>(T message, MessageEnvelop metadata, CancellationToken cancellationToken = default) where T : class;
    Task SubscribeAsync<T>(Func<T, MessageEnvelop, Task> handler, CancellationToken cancellationToken = default) where T : class;
